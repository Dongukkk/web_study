...
public class AppServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//--------------------viewResolver 설정 시점
		MyViewResolver myViewResovler = new MyViewResolver();
		...
		if(requestURI.equals("접속경로비교")) {
			...
			myView.viewName = myViewResovler.viewResolve(mav.viewName);
		...
		if(requestURI.equals("접속경로비교")) {
			...
			//myModel 데이터
			//viewName 스프링 값으로 view 이름 정보
			
			MyView myView = new MyView();
			myView.viewName = myViewResovler.viewResolve(viewName);
