...
public class Practice15CustomerController {
	...
	//고객 정보 등록 페이지로 연결	
	@GetMapping("/practice15/userManage")
	public String userManage() {
		
		return "practice/practice15/userManage";		
	}
	
	//등록페이지에서 사용자가 뭔가 저장할 정보를 입력한 후, 등록 요청
	// ---> POST 요청
	@PostMapping("/practice15/userManage")
	public String userManageAction(@ModelAttribute Practice15Customer practice15Customer) {
